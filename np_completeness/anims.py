    ...
    def construct(self):
        ...
        variables = Group(
            ...
            *[
                ...
                for str in [
                    ...
                    x3_str + eq_str + true_str,
                    x4_str + eq_str + false_str,
                ]
            ],
        ...
        plugged_constraints = Group(
            *[
                ...
                for str in [
                    true_str + or_str + left_str + not_str + false_str + right_str,
                    not_str + false_str,
                    false_str
                    + or_str
                    + left_str
        ...
        simplified_constraints = Group(
            *[
                Tex(str).scale(SIMPLIFIED_SCALE)
                for str in [
                    true_str + or_str + true_str,
                    true_str,
                    false_str + or_str + true_str + or_str + false_str,
                ]
            ]
        )
        ...
        self.play(*[Write(v[1:]) for v in variables[1:]])
        self.wait()

        # TODO glitch in the first transformation
        l = 6
        for i in range(l):
            if i < l - 1:
                self.play(
        ...
        cnf_sat_tex = Tex(r"CNF-SAT").scale(1.25).to_edge(DOWN, buff=1.7)
        arrow = Arrow(
